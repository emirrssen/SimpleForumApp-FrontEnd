        ...
        <AppCard style="width: 580px;">
            <template #centerContent>
                ...
                <AppCardBody class="mt-4 flex flex-col" style="gap: 12px;">
                    ...
                    <div class="columns-2 py-1">
                        <AppInputText type="text" placeholder="Seçiniz..." label="Doğum Tarihi" v-model="userToRegister.DateOfBirth" />
                    ...
                    <div class="columns-2 py-1">
                        ...
                        <AppInputText type="text" placeholder="05xx xxx xx xx" label="Telefon Numarası" v-model="userToRegister.DateOfBirth" />
                    </div>
                    <div class="columns-2 py-1">
                        <AppInputText type="password" placeholder="Seçiniz..." label="Şifre" v-model="userToRegister.DateOfBirth" />
                        <AppInputText type="password" placeholder="Seçiniz..." label="Şifre Tekrar" v-model="userToRegister.DateOfBirth" />
                    </div>
                </AppCardBody>
                <AppCardFooter class="mt-4 flex justify-end" style="gap: 12px;">
                    <AppButton type="text" title="Kayıt Ol" />
                    <AppButton type="info" title="Giriş Yap" />
                </AppCardFooter>
            </template>
        </AppCard>
    </div>
